...
const galleryImages = [
  {
    id: 1,
    src: "https://images.unsplash.com/photo-1560750588-73207b1ef5b8?q=80&w=1974",
    alt: "Salon Interior"
  },
  {
    id: 2,
  ...
  {
    id: 3,
    src: "https://images.unsplash.com/photo-1595867818082-083862f3d630?q=80&w=2070",
...
const GallerySection = () => {
  ...
  return (
    <section className="section-padding bg-beauty-nude/30">
